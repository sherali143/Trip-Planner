...
add_table(
    ...
    [
        ...
        ['demo_6agent_basic.py', 'DEMO — Runs the 6-agent approach with step-by-step print statements. For supervisor presentation.'],
        ['demo_3agent_basic.py', 'DEMO — Runs the 3-agent optimized approach with step-by-step prints. For supervisor presentation.'],
        ['demo_comparison.py', 'DEMO — Runs both approaches back-to-back and shows comparison metrics table.'],
