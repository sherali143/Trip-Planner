...
add_table(
    ...
    [
        ...
        ['run_demo_baseline.py', 'DEMO — Runs the 6-agent approach with step-by-step print statements. For supervisor presentation.'],
        ['run_demo_optimized.py', 'DEMO — Runs the 3-agent optimized approach with step-by-step prints. For supervisor presentation.'],
        ['run_demo_comparison.py', 'DEMO — Runs both approaches back-to-back and shows comparison metrics table.'],
        ...
        ['comparison/baseline_6agent.py', '6-agent baseline architecture for ablation study. Has 6 agents with MCP tools.'],
        ['comparison/optimized_3agent.py', '3-agent optimized architecture wrapper for comparison. Uses direct API calls.'],
