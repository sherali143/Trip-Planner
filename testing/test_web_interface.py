...
def _tones(console, refused=False):
    from trip_planner.ui.plan_layout import plan_checks
...
def test_both_recorded_formats_are_present():
    ...
    from trip_planner.ui.plan_layout import section_level
...
def test_the_section_level_is_the_one_that_repeats(name):
    ...
    """
    from trip_planner.ui.plan_layout import section_level, split_sections
...
def test_every_section_reaches_a_tab_and_nothing_is_dropped(name):
    ...
    """
    from trip_planner.ui.plan_layout import group_into_tabs, split_sections
...
def test_the_tabs_come_out_in_reading_order(name):
    ...
    from trip_planner.ui.plan_layout import group_into_tabs
...
def test_a_four_day_trip_yields_exactly_four_days(name):
    ...
    """
    from trip_planner.ui.plan_layout import group_into_tabs, split_days
...
def test_the_day_label_is_short_enough_to_read(name):
    ...
    """
    from trip_planner.ui.plan_layout import (MAX_DAY_LABEL, group_into_tabs,
                                             split_days)
...
def test_a_specific_heading_beats_a_generic_word_inside_it():
    ...
    makes that true.
    """
    from trip_planner.ui.plan_layout import tab_for
...
def test_a_budget_table_row_is_not_mistaken_for_a_day():
    ...
    from trip_planner.ui.plan_layout import split_days
...
def test_an_unrecognised_heading_still_gets_somewhere():
    ...
    from trip_planner.ui.plan_layout import group_into_tabs, tab_for
...
def test_the_layout_helpers_stay_out_of_the_streamlit_script():
    ...
    `from trip_planner.ui.app import split_days` drew the sidebar and the form
    ...
    leave a page behind.
    """
    import trip_planner.ui.plan_layout as layout
