...
def test_hotel_mcp():
    ...
    from src.server.mcp_server import search_hotels_comprehensive
...
def test_car_rental_mcp():
    ...
    from src.server.mcp_server import search_car_rentals
...
def test_web_search_mcp():
    ...
    from src.server.mcp_server import search_internet
...
def test_calculator_mcp():
    ...
    from src.server.mcp_server import calculate
