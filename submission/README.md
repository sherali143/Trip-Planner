...
|---|---|---|
| `CMP7200_Dissertation.docx` | The dissertation. **The main deliverable.** | `python -m report.build.build_report` |
| `CMP7200_Viva_Presentation.pptx` | The viva slides. Detail is in the speaker notes. | `python -m report.build.make_viva_deck` |
| `PROJECT_OVERVIEW.docx` | Plain-English guide to the whole project. Read this first. | `python -m report.build.make_handover` |
...
with each other or with the measured data. Edit the generators in `report/build/`
instead.
