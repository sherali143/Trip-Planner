...
Output goes to trip_planner/evaluation/results/, which is what every document reads.
"""
...
from trip_planner.evaluation.arm_d_three_agent_direct import run_three_agent_direct
from trip_planner.evaluation.arm_c_six_agent_tuned import run_six_agent_tuned
...
RESULTS_PATH = "trip_planner/evaluation/results/comparison_results.json"
...
def _save(payload):
    os.makedirs("trip_planner/evaluation/results", exist_ok=True)
...
def main():
    ...
    # Optional scenario filter: `python -m trip_planner.evaluation.run_comparison SC-01 SC-04`.
