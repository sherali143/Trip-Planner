...
RESULTS_DIR = os.path.join(ROOT, "trip_planner", "evaluation", "results")
...
def api_quota() -> Dict[str, Any]:
    ...
    Written by trip_planner/evaluation/check_quota.py, which has to make one live call per API
