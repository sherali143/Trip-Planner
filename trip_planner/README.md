...
| `core/safe_math.py` | Arithmetic evaluation for the calculator tool, without `eval`. The character-filter version it replaced blocked name lookups but not `9**9**9`. |
