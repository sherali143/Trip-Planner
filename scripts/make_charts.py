...
Nothing here is hardcoded: all values arrive through comparison.measured, the
...
from comparison import measured
from comparison.measured import ARM_ORDER
from scripts.figlib import (AQUA, BLUE, DPI, GREY, INK, INK_2, ORANGE, RED,
                            ROOT, save_chart)
