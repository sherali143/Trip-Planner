...
--------------------------
src/core/trip_cost.py makes a falsifiable claim: a budget below what the trip
...
Results are written to comparison/results/budget_gate.json.

    python -m comparison.exp_budget_gate
"""
...
from src.core.trip_cost import (assess_budget, estimate_trip_cost,
