...
like a real result.
    ...
    from comparison.measured import results, arm, protocol, budget_gate
"""
...
RESULTS_DIR = os.path.join(ROOT, "comparison", "results")
...
def code_stats() -> Dict[str, Any]:
    ...
    areas = {
        ...
        "testing": "test suite",
        "scripts": "figure and document generators",
